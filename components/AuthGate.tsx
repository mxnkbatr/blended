...
export function AuthGate({ children }: { children: React.ReactNode }) {
  ...
  if (loading) {
    return (
      <div className="flex min-h-[100dvh] items-center justify-center bg-achira-navy">
        <div className="h-10 w-10 animate-spin rounded-full border-2 border-achira-cream/20 border-t-achira-cream" />
      </div>
    );
  }
