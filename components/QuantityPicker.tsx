  ...
  return (
    <div className="inline-flex items-center rounded-2xl border border-achira-blue/12 bg-white/80 p-1 dark:border-achira-cream/12 dark:bg-achira-navy/50">
      <button
        ...
        className="grid h-9 w-9 place-items-center rounded-xl text-achira-blue/70 transition-colors hover:bg-achira-blue/8 hover:text-achira-blue-dark active:scale-95 dark:text-achira-cream/70 dark:hover:bg-achira-cream/10 dark:hover:text-achira-cream"
        aria-label="Хасах"
      >
